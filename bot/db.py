...
from sqlalchemy import Float, String, BigInteger, DateTime, Integer, ForeignKey
...
class Subscription(Base):
    ...
    last_reminded_on: Mapped[Optional[datetime]] = mapped_column(DateTime(timezone=True), nullable=True)
